<template>
    <div class="p-4 m-3 context-detail">
        ...
        <ul>
            <li>🔗 LangChain and LangGraph for agent orchestration</li>
            <li>🧠 Hugging Face models and open-source LLMs</li>
            <li>🤝 Multi-agent systems with autonomous decision making</li>
            <li>🌍 Multilingual AI systems for Sri Lankan languages</li>
        </ul>
